...
public class CustomerInApartmentSortedView extends VBox{
	...
	public CustomerInApartmentSortedView(CustomerController customerController) {
	...
	private void addComponants() {
		...
		this.button.setOnMouseClicked(e-> text.setText(customerController.getCustomerSortedForApartment(comboBox.getValue())));
	}
